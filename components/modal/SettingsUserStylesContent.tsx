...
export const SettingsUserStylesContent = () => {
  ...
  return (
    <View className="pb-4">
            ...
            <ScrollView className="max-h-[80vh]">
              ...
              <View className="mt-10 flex-row items-center justify-between gap-4">
                <View className="flex-row items-center gap-2">
                  <Pressable
                    onPress={closeDraft}
                    className="rounded-full border border-zinc-800 px-5 py-2.5 active:bg-zinc-900"
                  >
      ...
      {previewDefinition ? (
        <BaseCenterModal onClose={() => setPreviewBuiltinId(null)} containerClassName="lg:w-[50rem] xl:w-[60rem] max-w-[95vw]">
          <View className="p-6">
            <View className="flex-row items-center gap-3">
